...
/**
 * Class that deals with parsing and calculations of Linear functions. Implements methods from the Equations abstract class.
 * @author Taha
 *
 */
public class Linear extends Equations{
    private static final Pattern EQN = Pattern.compile("[Yy]=([+-]?\\d*\\.?\\d*)[Xx]([+-]?\\d*\\.?\\d*)");
    private double a;
    private double b;
    ...
    {
    		return "A linear function: y=ax+b where a = " + this.a
    				+ " and b = " + this.b + ".";
    }

    /**
     * Method to calculates the roots of the linear equation.
     */
	@Override
	public void getRoots() 
	{
		System.out.println("I found a solution: x= " + -this.b/this.a + ".");
	}
	...
	public void computeIntervals() 
	{
		...
		{
			this.yints[i]= this.a * xints[i] + this.b;
		}
